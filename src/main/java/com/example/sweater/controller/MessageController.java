...
public class MessageController {
	...
	@Value("${upload.path}") // Значение из properties файла
	...
	@PostMapping("/main")
	public String add(@AuthenticationPrincipal User user, @Valid Message message, BindingResult bindingResult, // bindingResult
																												// -
																												// список
																												// аргументов
																												// и
		...
		} else { // Если валидация прошла без ошибок - сохраняется сообщение
	...
	private void saveFile(Message message, MultipartFile file) throws IOException {
		if (file != null && !file.getOriginalFilename().isEmpty()) {
			...
			if (!uploadDir.exists()) {// Если директории для загрузки не существует - создать
				uploadDir.mkdir();
			}
